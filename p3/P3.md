...
- **Tipo 4**: Error sobre expresiones aritméticas complejas.

- **Tipo 5**: Expresiones aritmético-lógicas de sentencias compuestas. Se detectan todos los errores introducidos.

Problemas:
- El error de tipo 2 no se detecta correctamente (la primera linea si, la segunda no).
- En tipo 4, si abrimos un parentesis y no lo cerramos da problemas hasta que vuelve a encontrar otro parentesis que si cierra. Para probarlo, quitar los parentesis de la linea 37.
